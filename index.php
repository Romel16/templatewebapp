<?php
    ...
    require_once("models/socialmediaModels.php");
    $socialmedia = new socialmediaModels();
    $smx = $socialmedia->get_SocialMedia();
    /* print_r ($smx); */
    require_once("models/lenguajesModels.php");
    $lenguajes = new lenguajesModels();
    $lenx = $lenguajes->get_Lenguajes();
    /* print_r ($lenx); */ 

    require_once("models/cursoModels.php");
    $cursodestacado = new cursoModels();
    $curdx = $cursodestacado->get_Cursos();

    $curx = $cursodestacado->get_Cursos(); 
?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        ...
                        <h2>Hola, Soy <span>Admin</span></h2>
    ...
    <footer class="pt-50 pb-20 bg-grey">
        <div class="container">
                        ...
                        <div class="textwidget">
                            ...
                            <ul class="header-social-network d-inline-block list-inline color-white mb-20">
                                <?php
                                    for($i=0;$i<sizeof($smx);$i++){
                                ?>
                                    <li class="list-inline-item"><a class="<?php echo $smx[$i]["icon1"] ?>" href="<?php echo $smx[$i]["rutaweb"] ?>" target="_blank" title="<?php echo $smx[$i]["nombre"] ?>"><i class="elegant-icon <?php echo $smx[$i]["icon2"] ?>"></i></a></li>
                                <?php
                                    }
                                ?>
                            </ul>
            ...
            <div class="footer-copy-right pt-30 mt-20 wow fadeInUp animated">
                <p class="float-md-left font-small text-muted">© 2024, Stories - Personal Blog HTML Template </p>
